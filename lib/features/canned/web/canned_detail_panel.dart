...
class _CannedDetailPanelState extends ConsumerState<CannedDetailPanel> {
  ...
  Future<void> _onMenu(String value) async {
    ...
    switch (value) {
      case 'edit':
        ...
        return;
      case 'copy':
        await Clipboard.setData(ClipboardData(text: Fmt.stripHtml(c.body)));
  ...
  Widget _buildNarrow(ZebuTheme t, CannedResponse c) {
    return ListView(
      ...
      children: [
        ...
        if (_attachments.isNotEmpty) ...[
          const SizedBox(height: ZebuSpacing.s2),
          _SectionSubheader('Attachments', trailing: '${_attachments.length}'),
          Padding(
            padding: const EdgeInsets.fromLTRB(
              ZebuSpacing.s4,
              ZebuSpacing.s3,
  ...
  Widget _buildWide(ZebuTheme t, CannedResponse c) {
    return Row(
        ...
        DecoratedBox(
          ...
          child: SizedBox(
            ...
            child: ListView(
              ...
              children: [_FieldsTable(canned: c, sidebar: true)],
            ),
          ),
        ),
      ],
      ...
      child: Row(
        ...
        children: [
          if (canned == null)
            ...
            Expanded(
              child: Text(
                canned!.title.trim().isEmpty ? '(untitled)' : canned!.title,
                maxLines: 1,
    ...
    final rows = <Widget>[
      ...
      _FieldRow(
        ...
        value: _StatusValuePill(
          ...
          color: canned.isEnabled ? ZebuTheme.success : t.danger,
        ),
      ),
    ];
