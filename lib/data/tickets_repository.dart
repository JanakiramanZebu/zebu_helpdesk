...
class TicketsRepository {
  ...
  Future<Ticket> setStatus(int id, int statusId, {String? comments}) => _post(
    id,
    'status',
    {'status_id': statusId, if (comments != null) 'comments': comments},
  );

  Future<Ticket> assign(
    int id, {
    int? staffId,
    int? teamId,
    String? comments,
  ...
  Future<Ticket> transfer(int id, int deptId, {String? comments}) => _post(
    id,
    'department',
  ...
  Future<Ticket> mark(int id, String state) =>
      _post(id, 'mark', {'state': state});
  ...
  ) async => _ticket(await _api.post('/tickets/$id/$action', body: body));
  ...
  Future<List<Referral>> addReferral(
    int id, {
    int? staffId,
    int? teamId,
    int? deptId,
  ...
  Future<TicketRelations> link(int id, List<String> ticketNumbers) async {
    final body = await _api.post(
      '/tickets/$id/link',
      body: {'ticket_numbers': ticketNumbers},
    );
    return TicketRelations.fromJson(J.map(J.map(body)['data']));
  }
